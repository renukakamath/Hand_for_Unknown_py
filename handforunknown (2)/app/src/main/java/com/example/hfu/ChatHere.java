...
public class ChatHere extends Activity  implements JsonResponse
{
		...
		b1.setOnClickListener(new View.OnClickListener() 
		{
			public void onClick(View arg0)
			{
				...
				else
				{
			        ...
			        String q = "/chat?sender_id="+Login.logid+"&receiver_id="+sh.getString("receiver_id", "")+"&details="+chat;
			        q=q.replace(" ","%20");
			        JR.execute(q);
	...
	void getChats() {
			...
			JsonReq JR=new JsonReq();
	        JR.json_response=(JsonResponse) ChatHere.this;
	        String q = "/chatdetail?sender_id="+Login.logid+"&receiver_id="+sh.getString("receiver_id", "");
	        q=q.replace(" ","%20");
